# Microsoft Developer Studio Project File - Name="ARcBridgeOutDesign" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "ARcBridgeOutDesign.mak".
!MESSAGE 
...
# ADD LINK32 ACommon.lib ARoadConfig.lib HgGhostConc.lib ARcBridgeData.lib ARcBridgeDBDraw.lib ARcBridgeCalculate.lib XLReport.lib HgBaseBM.lib ARcBridgeOutBM.lib RCModule.lib BearingInfo.lib /nologo /subsystem:windows /dll /machine:I386 /def:".\ARcBridgeOutDesign.def" /out:"../../CommonCompile/Output/ARcBridgeOutDesign.dll" /implib:"../../CommonCompile/Output/ARcBridgeOutDesign.lib" /libpath:"../../../../Engine/BaseEng/CommonCompile/Output" /libpath:"../../../../Engine/BaseComp/CommonCompile/Output" /libpath:"../../../../Engine/FrameEng/CommonCompile/Output" /libpath:"../../../../Engine/Bim3DEng/CommonCompile/Output" /libpath:"../../../../Lib/Ubicon_Occ/CommonCompile/Output" /libpath:"../../CommonCompile/Output" /libpath:"../../../../Lib/XTPToolkitPro/CommonCompile/Output"
...
# ADD LINK32 ACommonD.lib ARoadConfigD.lib HgGhostConcD.lib ARcBridgeDataD.lib ARcBridgeDBDrawD.lib ARcBridgeCalculateD.lib XLReportD.lib HgBaseBMD.lib ARcBridgeOutBMD.lib RCModuleD.lib BearingInfoD.lib /nologo /subsystem:windows /dll /debug /machine:I386 /def:".\ARcBridgeOutDesignD.def" /out:"../../CommonCompile/OutputD/ARcBridgeOutDesignD.dll" /implib:"../../CommonCompile/OutputD/ARcBridgeOutDesignD.lib" /pdbtype:sept /libpath:"../../../../Engine/BaseEng/CommonCompile/OutputD" /libpath:"../../../../Engine/BaseComp/CommonCompile/OutputD" /libpath:"../../../../Engine/FrameEng/CommonCompile/OutputD" /libpath:"../../../../Engine/Bim3DEng/CommonCompile/OutputD" /libpath:"../../../../Lib/Ubicon_Occ\CommonCompile\OutputD" /libpath:"../../CommonCompile/OutputD" /libpath:"../../../../Lib/XTPToolkitPro/CommonCompile/OutputD"
...
# Name "ARcBridgeOutDesign - Win32 Release"
# Name "ARcBridgeOutDesign - Win32 Debug"
...
SOURCE=.\ARcBridgeOutDesignStd.h
# End Source File
# Begin Source File
...
SOURCE=.\OutBridgeResister.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignBridge.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignDlg.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignOptionSheet.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignXLProPage_Etc.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignXLProPage_Exel.h
# End Source File
# Begin Source File

SOURCE=.\OutDesignXLPropPage.h
# End Source File
# Begin Source File
...
SOURCE=.\res\ARcBridgeOutDesign.rc2
# End Source File
# End Group
# Begin Source File
